...
pcl::visualization::PCLVisualizer::Ptr initScene(Box window, int zoom)
{
	...
	viewer->addLine(pcl::PointXYZ(window.x_min, window.y_min, 0), pcl::PointXYZ(window.x_min, window.y_max, 0), 1, 1, 1, "line_ver1");
	viewer->addLine(pcl::PointXYZ(window.x_min, window.y_max, 0), pcl::PointXYZ(window.x_max, window.y_max, 0), 1, 1, 1, "line_horz1");
	viewer->addLine(pcl::PointXYZ(window.x_max, window.y_max, 0), pcl::PointXYZ(window.x_max, window.y_min, 0), 1, 1, 1, "line_ver2");
	viewer->addLine(pcl::PointXYZ(window.x_max, window.y_min, 0), pcl::PointXYZ(window.x_min, window.y_min, 0), 1, 1, 1, "line_horz2");
  	return viewer;
}
...
void Proximity(int idx, const std::vector<std::vector<float>> points, std::vector<int> &cluster,
